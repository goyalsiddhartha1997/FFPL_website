...
export default function App() {
  ...
  const renderAboutUs = () => (
    <div className="space-y-20 pb-20 bg-slate-50/50 animate-fade-in text-neutral-800">
      ...
      {/* Section 4: Redesigned High-End Company Leadership Board */}
      <section className="max-w-7xl mx-auto px-4 md:px-6 pt-10 space-y-12">
        <div className="text-center space-y-2 select-none">
          <span className="text-[#f05a28] font-mono text-xs font-bold tracking-widest uppercase">
            BOARD OF DIRECTORS
          </span>
          <h2 className="font-display text-3xl sm:text-4xl font-black text-[#0b1329] tracking-tight uppercase">
            Company Leadership
          </h2>
          <p className="text-neutral-500 font-sans text-sm max-w-xl mx-auto font-medium leading-relaxed">
            Backed by decades of polymer industrial practice, directing our plant towards absolute precision.
          </p>
          <div className="w-12 h-[3px] bg-[#f05a28] mx-auto mt-4 rounded-full"></div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {/* Director 1 */}
          <div className="bg-white border border-neutral-200/80 rounded-xl overflow-hidden shadow-xs hover:shadow-lg transition-all duration-300 flex flex-col h-full group">
            {/* Grayscale Visual Image with Bottom Fade & Text Overlay */}
            <div className="aspect-[4/3] relative overflow-hidden bg-slate-900">
              <img 
                src="https://images.unsplash.com/photo-1560250097-0b93528c311a?q=80&w=600&auto=format&fit=crop" 
                alt="Mr. Rajesh Sharma portrait" 
                referrerPolicy="no-referrer"
                className="w-full h-full object-cover object-top grayscale contrast-[110%] brightness-[105%] group-hover:scale-105 transition-transform duration-700"
              />
              <div className="absolute inset-0 bg-gradient-to-t from-[#0b1329]/95 via-[#0b1329]/50 to-transparent"></div>
              
              {/* Bottom Left Info Overlay */}
              <div className="absolute bottom-5 left-5 right-5 space-y-0.5 select-none">
                <p className="text-[#f05a28] font-mono text-[9px] font-bold tracking-widest uppercase">
                  FOUNDER & MANAGING DIRECTOR
                </p>
                <h3 className="text-white font-display text-lg sm:text-xl font-black tracking-tight uppercase">
                  Mr. Rajesh Sharma
                </h3>
              </div>
            </div>
            ...
            <div className="p-6 flex flex-col justify-between flex-grow space-y-6">
              <p className="text-neutral-600 font-sans text-xs sm:text-sm leading-relaxed italic font-normal">
                "With over 45 years of experience in this line as an elite packaging consultant and marketing expert, Rajesh directs our overall vision, machine strategies, and corporate growth plans across India."
              </p>

              {/* Subfooter */}
              <div className="pt-4 border-t border-neutral-100 flex items-center justify-between text-[11px] font-mono font-bold select-none text-neutral-400">
                <span className="uppercase tracking-wider">EXECUTIVE COUNCIL</span>
                <span className="text-[#f05a28] tracking-wider">ACTIVE PORTFOLIO</span>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white border border-neutral-200/80 rounded-xl overflow-hidden shadow-xs hover:shadow-lg transition-all duration-300 flex flex-col h-full group">
            ...
            <div className="aspect-[4/3] relative overflow-hidden bg-slate-900">
              <img 
                ...
                alt="Mr. Aditya Singhal portrait" 
                referrerPolicy="no-referrer"
                className="w-full h-full object-cover object-top grayscale contrast-[110%] brightness-[105%] group-hover:scale-105 transition-transform duration-700"
              />
              <div className="absolute inset-0 bg-gradient-to-t from-[#0b1329]/95 via-[#0b1329]/50 to-transparent"></div>
            ...
            <div className="p-6 flex flex-col justify-between flex-grow space-y-6">
              <p className="text-neutral-600 font-sans text-xs sm:text-sm leading-relaxed italic font-normal">
                "Aditya holds an engineering degree in polymer science. He oversees our Paonta Sahib manufacturing assets, focusing on continuous process optimization, machine speeds, automation, and line throughput."
              </p>
          ...
          <div className="bg-white border border-neutral-200/80 rounded-xl overflow-hidden shadow-xs hover:shadow-lg transition-all duration-300 flex flex-col h-full group">
            ...
            <div className="aspect-[4/3] relative overflow-hidden bg-slate-900">
              <img 
                ...
                alt="Mrs. Meenakshi Chaudhary portrait" 
                referrerPolicy="no-referrer"
                className="w-full h-full object-cover object-top grayscale contrast-[110%] brightness-[105%] group-hover:scale-105 transition-transform duration-700"
              />
              <div className="absolute inset-0 bg-gradient-to-t from-[#0b1329]/95 via-[#0b1329]/50 to-transparent"></div>
              ...
              <div className="absolute bottom-5 left-5 right-5 space-y-0.5 select-none">
                <p className="text-[#f05a28] font-mono text-[9px] font-bold tracking-widest uppercase">
                  HEAD OF DESIGN & CLIENT SOLUTIONS
                </p>
                <h3 className="text-white font-display text-lg sm:text-xl font-black tracking-tight uppercase">
                  Mrs. Meenakshi Chaudhary
                </h3>
              </div>
            </div>
            ...
            <div className="p-6 flex flex-col justify-between flex-grow space-y-6">
              <p className="text-neutral-600 font-sans text-xs sm:text-sm leading-relaxed italic font-normal">
                "With a background in functional design, Meenakshi works hand-in-hand with clients to match their foods or chemical profiles with exact multi-layer configurations and high-impact graphic prints."
              </p>
